...
export const Footer = () => {
    return (
      <div className="px-4 pt-16 bg-sky-900 mt-14 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              ...
              It serves as the basis for monitoring the activities of any enterprise and is necessary for a thorough study of the financial condition of the company. !
              </p>
              <p className="mt-4 text-sm text-gray-100">
              Accounting is difficult to learn, however, our online course will help you master the basics
              </p>
            </div>
          </div>
